...
<link rel="stylesheet" href="http://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.carousel.min.css">
<link rel="stylesheet" href="http://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.theme.default.css">
...
<section class="product-section section mt-40 mb-20 mb-lg-20 mb-md-20 mb-sm-20 mb-xs-0">
    <div class="container">
        <div class="col-xl-12">
            <h2 class="text-center h2-text-pslider mt-10 mb-10">New Arrival Product</h2>
            <p class="text-center p-text-pslider mb-40">Shop our new arrivals from established brands</p>
        </div>
        <!-- Swiper -->
        <div class="owl-carousel text-center">

            <div class="item">
                <div class="card product-grid4">
...
<!-- <div class="text-center">
    <div class="product-grid4">
        <div class="product-image4">
            ...
            <span class="product-new-label">New1</span>
